...
set ANALYSIS_HF_MAX_NEW_TOKENS=120
set ANALYSIS_HF_BATCH_SIZE=1
set ANALYSIS_HF_RETRY_MAX_NEW_TOKENS=160
set ANALYSIS_HF_REPAIR_MAX_NEW_TOKENS=100
set ANALYSIS_LLM_FALLBACK_TO_GROUNDED=false
set ANALYSIS_DISABLE_LLM_ON_CPU=false
